...
export default function CompetenciaBadge({ competencia }: { competencia: string }) {
  if (competencia === 'Competencia exclusiva municipal' || competencia === 'Exclusiva municipal' || competencia === 'Sí') {
    return (
  ...
  if (
    competencia === 'Competencia concurrente' ||
    competencia === 'Parcialmente viable' ||
